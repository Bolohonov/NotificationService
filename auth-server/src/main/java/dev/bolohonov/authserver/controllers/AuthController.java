package dev.bolohonov.authserver.controllers;


import dev.bolohonov.authserver.dto.AuthenticationRequest;
import dev.bolohonov.authserver.dto.AuthenticationResponse;
import dev.bolohonov.authserver.dto.RefreshTokenRequest;
import dev.bolohonov.authserver.jwt.JwtTokenProvider;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<AuthenticationResponse> login(@Valid @RequestBody AuthenticationRequest authRequest) throws
    ...
    @PostMapping("/refresh")
    public ResponseEntity<AuthenticationResponse> refreshToken(@Valid @RequestBody RefreshTokenRequest
                                                                           refreshTokenRequest) {
