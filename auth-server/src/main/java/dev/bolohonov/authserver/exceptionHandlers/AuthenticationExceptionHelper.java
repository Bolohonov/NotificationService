package dev.bolohonov.authserver.exceptionHandlers;

import dev.bolohonov.authserver.dto.ErrorResponseModel;
...
public class AuthenticationExceptionHelper {
    ...
    public ResponseEntity<ErrorResponseModel> handleIAccessDeniedException(AccessDeniedException ex,
                                                                           WebRequest request) {
        ErrorResponseModel errorResponseModel = new ErrorResponseModel();
    ...
    public ResponseEntity<ErrorResponseModel> handleIInvalidTypeIdException(MethodArgumentNotValidException ex,
                                                                            WebRequest request) {
